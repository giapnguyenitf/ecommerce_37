...
class OrderDetailController extends Controller
{
    ...
    public function updateOrderStatus($id, $status)
    {
        ...
        return $this->orderDetailRepository->update($id, $orderAccept);
    }
    ...
    public function showOrderDelivering()
    {
        ...
        return view('admin.deliveringOrder', compact('ordersDelivering'));
    }
    ...
    public function showDoneOrder()
    {
        ...
        return view('admin.doneOrder', compact('doneOrders'));
    }
    ...
    public function showCancelledOrder()
    {
        ...
        return view('admin.cancelOrder', compact('cancelledOrders'));
    }
}
