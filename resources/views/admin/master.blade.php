                ...
                <div class="sidebar-scroll">
                    <nav>
                        <ul class="nav">
                            ...
                            <li>
                                <a href="{{ route('order-detail.ordersDelivering') }}" class=""><i class="fa fa-file"></i><span>@lang('label.orders_delivering')</span></a>
                            </li>
                            <li>
                                <a href="{{ route('order-detail.doneOrders') }}" class=""><i class="fa fa-file"></i><span>@lang('label.orders_done')</span></a>
                            </li>
                            <li>
                                <a href="{{ route('order-detail.cancelOrders') }}" class=""><i class="fa fa-file"></i><span>@lang('label.orders_cancelled')</span></a>
                            </li>
                            <li>
                            <li>
